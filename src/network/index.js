...
export const todayRegisterUser = data =>http({url:`/statis/user/${data}/count`, method:'get'})
export const registerUser = () => http({url:'/v1/users/count',method:'get'})
export const todayOrderCount = data =>http({url:`/statis/order/${data}/count`,method:'get'})
export const todayAdminCount = data => http({url:`/statis/admin/${data}/count`,method:'get'})
